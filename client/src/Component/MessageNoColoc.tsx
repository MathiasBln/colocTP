...
return(
    ...
    <div className="container mt-5 pt-5 px-5 warning-background-50 d-flex flex-column shadow rounded">
        ...
        Le fait d'être colocataire donne accés à l'espace de gestion de votre colocation.</p>
        <p className="fs-4">Il est également possible qu'une mesure de sécurité ou un incident technique vous ait retiré votre statut de colocataire sur le site. 
        Dans ce cas il vous suffit de vous déconnecter et de vous reconnecter.</p>
